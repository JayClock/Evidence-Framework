  ...
  domain: {
    ...
    artifacts: [
      ...
      artifact({
        ...
        minChars: 900,
        requiredSections: ['限界上下文', '上下文关系'],
        minTableRows: 4,
        occurrences: [
          { needle: '```mermaid', minimum: 1, label: '上下文关系 Mermaid 图' },
        ],
      }),
      artifact({
