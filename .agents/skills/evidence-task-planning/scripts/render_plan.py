...
""".strip()
  template = f"""<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Content-Security-Policy" content="@@CSP@@"><title>{title} task plan review</title><style>{style}</style></head><body><header><div><h1>{title}</h1><p>Smart-domain task plan review projection</p></div><div id="validation"></div></header><div class="layout"><nav aria-label="Review views"><button class="active" data-view="overview">Overview</button><button data-view="tasks">Tasks</button><button data-view="gaps">Gaps</button><button data-view="sources-view">Sources</button><button data-view="raw-view">Raw YAML</button></nav><main><section class="view active" id="overview"><div class="metrics" id="metrics"></div><div class="panel"><h2>Strategy</h2><div id="strategy"></div></div></section><section class="view" id="tasks"><div class="toolbar"><button class="active" data-filter="all">All</button><button data-filter="planned">Planned</button><button data-filter="in-progress">In progress</button><button data-filter="blocked">Blocked</button><button data-filter="done">Done</button></div><div class="task-list" id="task-list"></div></section><section class="view" id="gaps"><div id="gaps-list"></div></section><section class="view" id="sources-view"><div class="panel" id="sources"></div></section><section class="view" id="raw-view"><pre id="raw"></pre></section></main></div><script type="application/json" id="plan-data">{data}</script><script>{app}</script></body></html>"""
