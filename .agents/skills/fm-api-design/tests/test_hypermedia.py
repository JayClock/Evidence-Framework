...
class HypermediaTest(unittest.TestCase):
    def test_navigation_does_not_auto_create_get(self) -> None:
        ...
        value["representations"] = [
            {
                ...
                "links": [
                    {
                        "rel": "payment-requests",
                        "targetResourceRef": "resource.payment-request",
                        ...
                        "visibleToRoleRefs": ["role.platform-subscription"],
                    }
                ],
                "basis": {
                    "fmRefs": ["contract.content-subscription#signed_at"],
        ...
        self.assertIn("LINK_GET_UNSELECTED", {item.code for item in diagnostics})
